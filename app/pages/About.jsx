  ...
  const items = [
    {
      title: "Estructura",
      description:
        "Ofrecemos una ubicación privilegiada en el corazón de San Carlos de Bariloche para nuestra oficina matriz. Integrada por un staff de profesionales comprometidos a brindar el mejor servicio al cliente. Contamos con una amplia red de servicios nacionales e internacionales y colaboramos con embarcadores para garantizar una cobertura completa.",
    },
    {
