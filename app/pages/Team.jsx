...
export default function Team() {
  ...
  return (
    <section
      id="team"
      className="z-50 justify-center items-center py-10"
      data-scroll-section
    >
      <div className="team flex flex-col items-center justify-center lg:px-0 px-6">
        <div className="relative w-full max-w-4xl mx-auto flex flex-col lg:flex-row items-center  bg-gradient-to-r from-[#93bec7] to-[#46939f] h-screen lg:h-[500px] rounded-3xl overflow-hidden">
          {/* Featured Member */}
          <div className="h-1/2 lg:h-full w-full lg:w-2/5 overflow-hidden">
            <div className="relative flex flex-col w-full h-full rounded-2xl">
              <img
                src="/member2.png"
                alt="Featured Member"
          ...
          {/* Quote Section */}
          <div className="lg:w-3/5 lg:h-full w-full h-1/2 flex justify-center items-center bg-white border-gray-300 border p-10">
            <div className="relative mt-10">
              ...
              <div className=" p-2 z-20 w-full">
                <span className="text-sm text-black sm:text-lg text-gray-600 mt-2 uppercase block text-left ml-4">
                  Director
                </span>
                <h3 className="text-xl text-black font-bold text-left ml-4">
