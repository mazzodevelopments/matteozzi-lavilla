  ...
  return (
    ...
    >
      <div className="team flex flex-col items-center justify-center lg:px-0 px-6">
        <div className="relative w-full max-w-5xl mx-auto flex flex-col lg:flex-row items-center  bg-gradient-to-r from-[#93bec7] to-[#46939f] h-screen lg:h-[500px] rounded-3xl overflow-hidden">
          {/* Featured Member */}
